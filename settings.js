...
global.owner = process.env.OWNER_NUMBER  || '254745294543' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LENz0A7T#UN4uJIzhwv_RGRYiXEL-puLpNWDmyweN35fV0Qa5Vgo' ,
